...
function App() {
  ...
  return <div className="app-shell">
    <header className="topbar">
      ...
      <div className="header-actions"><button className="city">Singapore <ChevronDown size={15} /></button><button className="avatar" onClick={() => setAccountOpen(true)}><CircleUserRound size={19} /><span>{profile?.displayName ?? (session ? 'Account' : 'Sign in')}</span></button><button className="menu"><Menu /></button></div>
    </header>
